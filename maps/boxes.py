...
def get_country_bounding_box(country_name):

    for country in countries:
        if str.upper(country_name) in str.upper(countries[country][0]):
            print(countries[country][0], " <--- name")
            print(countries[country][1], "<--- coords")
            return {
                "point_1_long_lat": [
                ...
                "point_2_long_lat": [
                    countries[country][1][2],
                    countries[country][1][3],
                ],
            }


print(get_country_bounding_box("KE"))
